...
public class LongRingElement 
    extends NumericRingElement<Long, LongRingElement> 
{
    ...
    public LongRingElement create(Long value) {
        return this.value == value ? this : new LongRingElement(value);
    }

    @Override
    public LongRingElement create(Integer value) {
