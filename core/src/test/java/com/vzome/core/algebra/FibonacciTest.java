...
public class FibonacciTest {
    ...
    public final <T extends Fields.Element<T>> T variableFibonacci(int reps, T... args) {
    ...
    public void testVariableFibonacci() {
        {
            ...
            BigRational fib = variableFibonacci(92, BigRational.ONE, BigRational.ONE);
            ...
            fib = variableFibonacci(95, BigRational.ONE, BigRational.ONE.negate());
            assertEquals("-7540113804746346429", fib.toString());
            assertTrue(fib.fitsInLong());
        }
        {
        ...
        }
        {
            ...
            BigRational fib = variableFibonacci(10000, BigRational.ONE, BigRational.ONE);
        ...
        }
        {
            ...
            BigRational fib = variableFibonacci(93, BigRational.ONE, BigRational.ONE);
    ...
    public void testVaribonacciWithUnitTerms() {
        ...
        for (AlgebraicField field : fields) {
            ...
            for (int r = 1; r <= reps; r++) {
                ...
                AlgebraicNumber fib = variableFibonacci(r, array);
