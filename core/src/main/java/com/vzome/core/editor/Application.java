...
public class Application
{
    ...
    public Application(boolean enableCommands, Command.FailureChannel failures, Properties overrides) {
        ...
        addFieldApplicationFunction("polygon", PolygonFieldApplication::new, PolygonField.MIN_SIDES, PolygonFieldApplication.MAX_SIDES);
        addFieldApplicationFunction("sqrt", SqrtFieldApplication::new, 1, SqrtField.MAX_VALUE);
    }
