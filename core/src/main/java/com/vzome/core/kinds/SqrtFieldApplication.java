 ...
 * @author David Hall
 *
 *         This is initially just a copy of RootThreeFieldApplication
 *
 */
public class SqrtFieldApplication extends DefaultFieldApplication<SqrtField> {
    public SqrtFieldApplication(int radicand) {
        ...
        AbstractShapes defaultShapes = new ExportedVEFShapes(null, "rootThreeOctaSmall", "small octahedra",
                "small connectors", symm);
    ...
    final SymmetryPerspective dodecagonalPerspective = new SymmetryPerspective() {
        ...
        private final AbstractShapes hexagonShapes = new DodecagonalShapes("dodecagonal", "hexagons", "flat hexagons",
                symmetry);
        ...
        public List<Tool> predefineTools(Tool.Kind kind, ToolsModel tools) {
            ...
            case SYMMETRY:
                result.add(new SymmetryTool.Factory(tools, this.symmetry)
                        .createPredefinedTool("dodecagonal antiprism around origin"));
